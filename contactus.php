				...
				<div>
					...
					<ul class="info">
						...
						<li>
							...
							<span>contactblackbookstores@gmail.com</span>
						</li>
						<li>
							<span><i class="fas fa-phone-alt"></i></span>
							<span>8303520892 <br> 8009126892</span>
						</li>
					</ul>
				</div>
				<ul class="sci">
...
if(isset($_POST['submit'])&&$count<2)
{$fname=$_POST['fname'];
	$to_email="contactblackbookstores@gmail.com";
	$lname=$_POST['lname'];
	$email=$_POST['email'];
	$mob=$_POST['mob'];
	$msg=$_POST['msg'];
	...
	$body="Hi , its $fname $lname .My email id and mobile no is $email and $mob.
	$msg";
	...
	if(mail($to_email,$subject,$body,$headers))
	{
	   $count++;
		?>
		<script>alert('Message sent to Blackbooks Developers!')</script>$
		<?php
	}
}
